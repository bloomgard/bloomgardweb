        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-slate-700 leading-relaxed font-medium mb-6">
              Our plan for the QNTM division is to bring commercial quantum computing to the cloud, fully governed by advanced Artificial Intelligence protocols.
            </p>
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              We plan to establish the infrastructure for cloud quantum computing in India. By fusing AI with quantum mechanics, our future AI models will actively manage qubit error correction and optimize quantum logic gates dynamically, supercharging our AI fintech enterprise solutions.
            </p>
          </div>
          <div className="relative h-[600px] w-full bg-white border border-gray-200 shadow-xl p-4">
            <div className="relative w-full h-full">
              <Image src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=1200" alt="Quantum computer hardware" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            ...
            <h3 className="text-xl font-bold mb-4">Future Cloud Integration</h3>
            <p className="text-slate-600 leading-relaxed">We plan to develop API layers that allow standard enterprise AI applications to offload complex algorithms to quantum processors seamlessly.</p>
          </div>
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            <CheckCircle2 className="w-8 h-8 text-blue-700 mb-6" />
            <h3 className="text-xl font-bold mb-4">Future AI Qubit Management</h3>
            <p className="text-slate-600 leading-relaxed">We plan to use neural networks to actively predict and suppress quantum decoherence, drastically improving computation accuracy.</p>
          </div>
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            <CheckCircle2 className="w-8 h-8 text-blue-700 mb-6" />
            <h3 className="text-xl font-bold mb-4">Future Fintech Acceleration</h3>
            <p className="text-slate-600 leading-relaxed">We plan to use quantum algorithms to run millions of Monte Carlo simulations for institutional portfolio optimization in seconds.</p>
          </div>
        </div>
      </section>
    </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              We plan to build the definitive financial erp. In the future, our AI fintech enterprise solutions will act as an impenetrable digital security guard, analyzing transactions instantly to halt fraud, optimize trading algorithms, and drastically reduce banking overhead.
            </p>
          </div>
          <div className="relative h-[600px] w-full bg-white border border-gray-200 shadow-xl p-4">
            <div className="relative w-full h-full">
              <Image src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=1200" alt="Stock market ticker data" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            ...
            <h3 className="text-xl font-bold mb-4">Future Automated Fraud Detection</h3>
            <p className="text-slate-600 leading-relaxed">We plan to build deep learning models that analyze user behavioral biometrics and transaction history in real-time to block unauthorized transfers.</p>
          </div>
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            <CheckCircle2 className="w-8 h-8 text-blue-700 mb-6" />
            <h3 className="text-xl font-bold mb-4">Future Algorithmic Compliance</h3>
            <p className="text-slate-600 leading-relaxed">We plan to build software that automatically audits financial flows against ever-changing international regulatory laws, preventing massive fines.</p>
          </div>
          <div className="bg-white p-8 border border-gray-200 shadow-sm">
            <CheckCircle2 className="w-8 h-8 text-blue-700 mb-6" />
            <h3 className="text-xl font-bold mb-4">Future High-Frequency Trading AI</h3>
            <p className="text-slate-600 leading-relaxed">We plan to build predictive models that digest global news sentiment and market data to execute micro-second institutional trades.</p>
          </div>
        </div>
      </section>
    </div>
